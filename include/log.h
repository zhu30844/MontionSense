...
#define LOG_INFO(format, ...)                                                                      \
	do {                                                                                           \
		...
		if (enable_minilog)                                                                        \
			...
			fprintf(stderr, "[INFO]\t[%s]\t\t[%s]:\t" format, LOG_TAG, __FUNCTION__, ##__VA_ARGS__);       \
	} while (0)
...
#define LOG_WARN(format, ...)                                                                      \
	do {                                                                                           \
		...
		if (enable_minilog)                                                                        \
			...
			fprintf(stderr, "[WARM]\t[%s]\t\t[%s]:\t" format, LOG_TAG, __FUNCTION__, ##__VA_ARGS__);       \
	} while (0)
...
#define LOG_ERROR(format, ...)                                                                     \
	do {                                                                                           \
		...
		if (enable_minilog)                                                                        \
			...
			fprintf(stderr, "[ERROR]\t[%s]\t\t[%s]:\t" format, LOG_TAG, __FUNCTION__, ##__VA_ARGS__);      \
	} while (0)
...
#define LOG_DEBUG(format, ...)                                                                     \
	do {                                                                                           \
		...
		if (enable_minilog)                                                                        \
			...
			fprintf(stderr, "[DEBUG]\t[%s]\t\t[%s]:\t" format, LOG_TAG, __FUNCTION__, ##__VA_ARGS__);      \
	} while (0)
